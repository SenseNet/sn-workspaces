...
SN.WorkspaceMembers = {
    ...
    okRemove: function () {
        ...
        $.post("/OData.svc/('root')/WorkspaceRemoveMember",
        "models=[" + JSON.stringify({ groupId: $groupid.val(), memberId: $userid.val() }) + "]",
    ...
    okAdd: function () {
        ...
        $.post("/OData.svc/('root')/WorkspaceAddMembers",
        "models=[" + JSON.stringify({data: dataStr}) + "]",
        SN.WorkspaceMembers.membersAdded);
    },
    cancelAdd: function () {
